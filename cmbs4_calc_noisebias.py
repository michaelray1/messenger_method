...
list_of_noise_input_iqu = []
for x in range(NSIMS):
    i_q_u1 = hp.read_map('/users/PES0740/ucn3066/CMBS4_maps/cmbs4_04_noise_f095_b24_ellmin30_map_0512_mc_{:04d}.fits'.format(x+(10*INDEX)),field = (0,1,2))
    ...
    list_of_noise_b_spectra1.append(second)
    list_of_noise_input_iqu.append(i_q_u)
list_of_noise_b_spectra = np.array(list_of_noise_b_spectra1)

os.chdir('/users/PES0740/ucn3066/messenger/CMBS4/Noise')
np.savez('Output Noise Spectra eta825_array{}.npz'.format(INDEX),list_of_noise_b_spectra)
np.savez('Input Noise Maps{}.npz'.format(INDEX),list_of_noise_input_iqu)
